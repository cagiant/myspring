package com.cagiant.de.applicationdemo.context;

import com.cagiant.de.applicationdemo.foo.FooConfig;
...
@Slf4j
public class ContextDemoApplication implements ApplicationRunner {
